    ...
    <div className="max-w-lg flex flex-col gap-2 text-sm">
      ...
      <div>
        ...
        <div className="grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700">
          ...
          {isEdit ? (
            <input className="bg-gray-10 max-w-52 "
          ...
          <p className="font-medium">Address: </p>
          {
            ...
            ? <p>
              ...
              <br />
              <input className="bg-gray-50" onChange={(e) => setUserData(prev => ({...prev.address, line2 :e.target.value }))} vallue={userData.address.line2} type="text" />
            </p>
